        ...
        <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-[20px] sm:p-[40px] font-['Outfit']">
            <div className="max-w-[1280px] mx-auto w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[20px] sm:gap-[32px] justify-center">
                    ...
                    {/* Reminders Card */}
                    <Link to="/manufacturing/reminders" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-blue-50/50 hover:bg-blue-50 border border-blue-100/50 hover:border-blue-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-blue-500/20 active:scale-95">
                    ...
                    {/* Expense Card */}
                    <Link to="/manufacturing/expenses" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-emerald-50/50 hover:bg-emerald-50 border border-emerald-100/50 hover:border-emerald-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-emerald-500/20 active:scale-95">
                        <div className="w-[72px] h-[72px] sm:w-[96px] sm:h-[96px] bg-[#00d287] rounded-[24px] sm:rounded-[32px] flex items-center justify-center shadow-lg shadow-emerald-500/30 group-hover:scale-110 transition-transform duration-300 mb-[24px] sm:mb-[32px]">
                            <Wallet className="w-[32px] h-[32px] sm:w-[40px] sm:h-[40px] text-white" />
                        </div>
                        <h2 className="text-[20px] sm:text-[24px] font-black text-[#00d287] tracking-tight group-hover:tracking-wide transition-all">Expense</h2>
                    </Link>

                    {/* Attendance Card */}
                    <Link to="/manufacturing/attendance" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-orange-50/50 hover:bg-orange-50 border border-orange-100/50 hover:border-orange-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-orange-500/20 active:scale-95">
                    ...
                    {/* Team Management */}
                    <Link to="/manufacturing/team" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-purple-50/50 hover:bg-purple-50 border border-purple-100/50 hover:border-purple-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-purple-500/20 active:scale-95">
